...
{
    public class RibbonProfesionalRendererColorTableSystemColors
         : RibbonProfesionalRendererColorTable
    {
        // TODO: Improve this. It only works for the Office 2013 style.
        public RibbonProfesionalRendererColorTableSystemColors()
        {
            #region Fields
            ...
            if(borderColor.ToArgb() == SystemColors.Control.ToArgb())
            {
                if(SystemColors.Control.GetBrightness() < 0.5f)
                {
                    // brighten
                    borderColor = Color.FromArgb(
                        Math.Min(borderColor.R + d, 255),
                        Math.Min(borderColor.G + d, 255),
                        Math.Min(borderColor.B + d, 255));
                }
                else
                {
                    // darken
                    borderColor = Color.FromArgb(
                        Math.Max(borderColor.R - d, 0),
                        Math.Max(borderColor.G - d, 0),
                        Math.Max(borderColor.B - d, 0));
                }
            }

            ButtonChecked_2013 = SystemColors.ControlLight;
            ButtonPressed_2013 = SystemColors.ControlLight;
            ButtonSelected_2013 = SystemColors.ControlLight;
            OrbButton_2013 = FromHex("#0072C6");
            OrbButtonSelected_2013 = FromHex("#2A8AD4");
            OrbButtonPressed_2013 = FromHex("#2A8AD4");

            TabText_2013 = SystemColors.ControlText;
            TabTextSelected_2013 = SystemColors.ControlText;
            PanelBorder_2013 = borderColor;

            RibbonBackground_2013 = SystemColors.Control;
            TabCompleteBackground_2013 = SystemColors.Control;
            TabNormalBackground_2013 = SystemColors.Control;
            TabActiveBackbround_2013 = SystemColors.Control;

            TabBorder_2013 = borderColor;
            TabCompleteBorder_2013 = borderColor;

            TabActiveBorder_2013 = borderColor;

            OrbButtonText_2013 = SystemColors.ControlText;
            PanelText_2013 = SystemColors.ControlText;
            RibbonItemText_2013 = SystemColors.ControlText;
            ToolTipText_2013 = SystemColors.ControlText;

            ToolStripItemTextPressed_2013 = SystemColors.HighlightText;
            ToolStripItemTextSelected_2013 = SystemColors.HighlightText;
            ToolStripItemText_2013 = SystemColors.ControlText;
